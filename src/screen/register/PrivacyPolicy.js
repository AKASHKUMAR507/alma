        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View style ={{rowGap:28,marginTop:20}}>
              <View style ={{rowGap:10}}>
                  ...
                  <Text style = {styles.textColor2}>Thank you for visiting BITBHARAT.com (“BITBHARAT”), a digital asset trading website, which is provided by Aux Cayes FinTech Co. Ltd. By visiting, accessing, or using BITBHARAT.com and associated application program interface or mobile applications (“Site”)</Text>
              </View>
              <View style ={{rowGap:10}}>
