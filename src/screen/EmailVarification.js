...
// }
// const GENERATE_RANDOM_OTP = generateRandomOTP().toString().split('');
// console.warn(`verification code ${GENERATE_RANDOM_OTP}`);
// const OTP = GENERATE_RANDOM_OTP;

const EmailVarification = ({navigation, route}) => {
